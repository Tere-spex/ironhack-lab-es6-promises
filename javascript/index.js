...
async function prepareBrusselsSprouts() {
...
prepareBrusselsSprouts();

// Bonus 2 - Promise all
function getBroccoli(){
  ...
  .then((value) => value.forEach(element => document.querySelector("#broccoli").innerHTML += `<li>${element}</li>`))
